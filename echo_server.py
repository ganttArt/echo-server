    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                # sock.close()
                # closing the socket here, as suggested above, is causing the tests to fail.
                # created a socket timeout as an alternative, with the exception handling happening right below
